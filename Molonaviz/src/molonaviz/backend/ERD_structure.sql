...
-- Table: Thermometer
CREATE TABLE Thermometer (ID INTEGER PRIMARY KEY AUTOINCREMENT, Name VARCHAR NOT NULL, ManuName VARCHAR, ManuRef VARCHAR, Error REAL NOT NULL, Beta REAL, V REAL, Labo INTEGER REFERENCES Labo (ID));
