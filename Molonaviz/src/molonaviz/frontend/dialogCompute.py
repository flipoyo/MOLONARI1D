...
class DialogCompute(QtWidgets.QDialog, From_DialogCompute):
    ...
    def InitValues(self):
        ...
        for i in range(len(self.input)):
            ...
            self.tableWidget.setItem(i, 0, QTableWidgetItem(str(self.layers[i]))) # *100 # Convert into centimenters
            ...
            self.tableWidget.setItem(i, 4, QTableWidgetItem(str(int(self.input[i][3]))))
    ...
    def setDefaultValues(self):
        ...
        self.tableWidget.setItem(0, 4, QTableWidgetItem(str(int(self.input[0][3]))))
    ...
    def getInputDirectModel(self):
        ...
        for i in range (nb_layers):
            perm = float(self.tableWidget.item(i, 1).text())
            log10permeability.append(-log10(abs(perm))) # Apply -log10 to the permeability values
            porosity.append(float(self.tableWidget.item(i, 2).text()))
            thermconduct.append(float(self.tableWidget.item(i, 3).text()))
            thermcap.append(float(self.tableWidget.item(i, 4).text()))
