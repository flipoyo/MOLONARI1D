...
RHO_W = 1000
C_W = 4185
ALPHA = 0.5 # ALPHA tel le schéma est implicite pour ALPHA = 1. Pour une bonne stabilité tout en gardant une bonne précision, on prendra ALPHA = 0.6 (Crank-Nicolson)
G = 9.81
EPSILON = 1e-10
N_UPDATE_MU = 96
MU = 1e-3
